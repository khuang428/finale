...
void my_main() {
  ...
  case LIGHT:
    ...
    break;
  case SHADING:
    if(strcmp("flat",op[i].op.shading.p->name)==0) shadeType = 0;
    else if(strcmp("goroud",op[i].op.shading.p->name)==0) shadeType = 1;
    else if(strcmp("phong",op[i].op.shading.p->name)==0) shadeType = 2;
	case SET:
